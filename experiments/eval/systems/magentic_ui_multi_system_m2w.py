...
from magentic_ui.eval.models import BaseTask, BaseCandidate, OnlineMind2WebCandidate
...
class MagenticUIMultiAutonomousSystemM2W(BaseSystem):
    """
    ...
    def __init__(
        ...
        name: str = "MagenticUIMultiAutonomousSystem",
        dataset_name: str = "Gaia",
        web_surfer_only: bool = False,
        use_local_browser: bool = False,
    ):
        super().__init__(name)
        self.candidate_class = OnlineMind2WebCandidate
    ...
    def get_answer(
        ...
        answer = OnlineMind2WebCandidate(answer=answer, screenshots=screenshots_paths)
